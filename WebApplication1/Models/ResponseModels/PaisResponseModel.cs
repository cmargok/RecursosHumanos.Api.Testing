...
namespace RecursosHumanos.API.Models.ResponseModels
{
    ...
    public class PaisConCiudades
    {
        ...
        public IEnumerable<CiudadModelAlone>? ciudades { get; set; }
    }

    public class PaisesConCiudades
    {
        public IEnumerable<PaisConCiudades>? PaisConCiudades { get; set; }
    }
